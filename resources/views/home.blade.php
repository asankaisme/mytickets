...
@role('Client')
  <div class="col-md-11">
    <div class="border mb-3 py-2 text-white px-2" style="background-color: rgba(7, 145, 7, 0.705)">
      User Activities <span><i class="fas fa-angle-double-right" style="color: honeydew"></i> {{ Auth::user()->roles->pluck('name')->implode('') }}</span>
    </div>
  </div>
  <div class="col-md-12">
    <div class="row">
    ...
    <div class="row">
      <div class="col-12 col-sm-6 col-md-2">
        <div class="info-box mb-3">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Assigned</span>
            <span class="info-box-number">{{ $allSupEngAssignedTickets }}</span>
          </div>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-2">
        <div class="info-box mb-3">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Accepted</span>
            <span class="info-box-number">{{ $allSupEngAcceptedTickets }}</span>
          </div>
        </div>
      </div>
      <div class="col-12 col-sm-6 col-md-2">
        <div class="info-box mb-3">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Completed</span>
            <span class="info-box-number">{{ $allSupEngCompletedTickets }}</span>
          </div>
        </div>
      </div>
    </div>
